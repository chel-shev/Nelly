...
//
//
//    public ExamTask(FastEventService<E> eventService, LanguageService languageService, FastSender sender, E e, Calendar calendar) {
...
//            eventService.save(e);
//            if (e.getTimeline() == FastStudyTimelineType.T_0) {
//                FastStudyTimeType next = e.getTime().getNext();
