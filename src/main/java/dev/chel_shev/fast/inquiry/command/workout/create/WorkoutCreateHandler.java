package dev.chel_shev.fast.inquiry.command.workout.create;
...
public class WorkoutCreateHandler extends FastInquiryHandler<WorkoutCreateInquiry> {

    private final WorkoutCreateConfig workoutAddConfig;
    ...
    @Override
    public void preparationLogic(WorkoutCreateInquiry i, Message message) {
    ...
    public void inlineExecutionLogic(WorkoutCreateInquiry i, CallbackQuery cq) {
    ...
    @Override
    public void inlinePreparationLogic(WorkoutCreateInquiry i, CallbackQuery cq) {
        if (isNullOrEmpty(i.getWorkoutName())) {
